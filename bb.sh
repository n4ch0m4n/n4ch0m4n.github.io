...
global_variables() {
    ...
    # Blog title
    global_title="n4ch0m4n blog"
    # The typical subtitle for each blog
    global_description="A blog about things"
    # The public base URL for this blog
    global_url="http://n4ch0m4n.github.io/"

    # Your name
    global_author="n4ch0m4n"
    # You can use twitter or facebook or anything for global_author_url
    #global_author_url="http://twitter.com/example" 
    # Your email
    global_email="n4ch0m4n@disroot.org"
